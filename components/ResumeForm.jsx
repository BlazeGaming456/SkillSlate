      ...
      <div className='w-1/2 p-6 space-y-6'>
        ...
        {step === 3 && (
          <>
            ...
            <div>
              <textarea onChange={(e)=>setAiExperiencePrompt(e.target.value)}></textarea>
              <ReactMarkdown>{aiExperienceResponse}</ReactMarkdown>
              <button onClick={handleExperienceAi} className='p-2 bg-blue-400 hover:bg-blue-500 hover:cursor-pointer'>Generate</button>
            </div>
            <div className='mt-4 flex gap-4'>
              <button
                onClick={() => setStep(2)}
